...
export const PlaygroundEditor = ({
  ...
  return (
    <div className="h-full relative">
      {/* Loading indicator */}
      {suggestionLoading && (
        <div className="absolute top-2 right-2 z-10 bg-red-900 px-2 py-1 rounded text-xs text-red-300 flex items-center gap-1">
      ...
      {currentSuggestionRef.current && !suggestionLoading && (
        <div className="absolute top-2 right-2 z-10 bg-green-900 px-2 py-1 rounded text-xs text-green-300 flex items-center gap-1">
